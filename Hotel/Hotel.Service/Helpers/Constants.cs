namespace Hotel.Service.Helpers
{
    internal class Constants
    {
        public static class CommonMessages
        {
            ...
            public static string HasRecords = "It Has records with {0}";
        ...
        { 
            ...
            public const string CurrentDayEqualGreater = "The checkin day must be greater than the current day";
            public const string CannotChangeStatus = "You cannot change the status of the booking because its current status is {0}";
        }
